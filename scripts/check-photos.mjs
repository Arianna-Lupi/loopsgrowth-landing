...
import { closingSteps, evaluatePhotoGate, evaluateTeamPhotoGate, parseElection, parseLicenses, parseTeamProvenance, sha256File, teamClosingSteps, validateLicenses, validateTeamProvenance } from './lib/photo-licenses.mjs';
...
for (const w of [...warnings, ...team.warnings]) console.warn(`WARN check-photos: ${w}`);
